const recipeRemovals = [
  { output: "dimensionalpocketsii:dimensional_elytraplate" },
  { output: "dimensionalpocketsii:dimensional_boots_enhanced" },
  { output: "dimensionalpocketsii:dimensional_leggings_enhanced" },
  { output: "dimensionalpocketsii:dimensional_chestplate_enhanced" },
  { output: "dimensionalpocketsii:dimensional_helmet_enhanced" },
  { output: "dimensionalpocketsii:dimensional_shield_enhanced" },
  { output: "dimensionalpocketsii:dimensional_trident_enhanced" },
  { output: "dimensionalpocketsii:dimensional_sword_enhanced" },
  { output: "dimensionalpocketsii:dimensional_hoe_enhanced" },
  { output: "dimensionalpocketsii:dimensional_shovel_enhanced" },
  { output: "dimensionalpocketsii:dimensional_axe_enhanced" },
  { output: "dimensionalpocketsii:dimensional_pickaxe_enhanced" },
  { output: "dimensionalpocketsii:dimensional_sword_enhanced" },
  { output: "dimensionalpocketsii:dimensional_boots" },
  { output: "dimensionalpocketsii:dimensional_leggings" },
  { output: "dimensionalpocketsii:dimensional_chestplate" },
  { output: "dimensionalpocketsii:dimensional_helmet" },
  { output: "dimensionalpocketsii:dimensional_shield" },
  { output: "dimensionalpocketsii:dimensional_trident" },
  { output: "dimensionalpocketsii:dimensional_sword" },
  { output: "dimensionalpocketsii:dimensional_hoe" },
  { output: "dimensionalpocketsii:dimensional_shovel" },
  { output: "dimensionalpocketsii:dimensional_axe" },
  { output: "dimensionalpocketsii:dimensional_pickaxe" },
  { output: "dimensionalpocketsii:dimensional_sword" },
  { output: "dimensionalpocketsii:nether_star_shard" },
  { output: "dimensionalpocketsii:dimensional_shard" },
  { output: "dimensionalpocketsii:dimensional_dust" },
  { output: "dimensionalpocketsii:dimensional_ingot" },
  { output: "dimensionalpocketsii:dimensional_gem" },
  { output: "dimensionalpocketsii:nether_star_shard" },
